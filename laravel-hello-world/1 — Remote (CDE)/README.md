# Laravel Hello World — Remote Environment

This is a remote (CDE) environment for [Laravel Hello World (info + deploy)](https://app.zerops.io/recipes/laravel-hello-world?environment=remote-cde) recipe on [Zerops](https://zerops.io).
